...
public class Game extends Group{
	...
	public Game(int w, int h, String pozadie) {
		...
		Image crosshairImage = new Image("cross.png");
        this.crosshairImageView = new ImageView(crosshairImage);
        this.crosshairImageView.setFitWidth(100); 
        this.crosshairImageView.setFitHeight(80);
		getChildren().addAll(background,zb,vystrel,zasah,crosshairImageView);
		zb.setY(450);
		zb.setX(250);
        ...
        this.setOnMouseMoved(e -> moveCursor(e));
	...
	public void moveCursor(MouseEvent me) {
		...
		this.crosshairImageView.setTranslateX(me.getSceneX());
		this.crosshairImageView.setTranslateY(me.getSceneY());
	}
